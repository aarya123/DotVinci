...
public class SepiaFilter implements IFilter{
	...
	public Pixel filterPixel(Pixel pixel) {
		double red=pixel.getRed(),green=pixel.getGreen(),blue=pixel.getBlue();
		double newRed = RED_MULTIPLES[0]*red+RED_MULTIPLES[1]*green+RED_MULTIPLES[2]*blue;
		double newGreen = GREEN_MULTIPLES[0]*red+GREEN_MULTIPLES[1]*green+GREEN_MULTIPLES[2]*blue;
		double newBlue = BLUE_MULTIPLES[0]*red+BLUE_MULTIPLES[1]*green+BLUE_MULTIPLES[2]*blue;
